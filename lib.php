...
/**
 * butinymce text editor integration.
 *
 * @package    editor
 * @subpackage butinymce
...
class butinymce_texteditor extends texteditor {
    ...
    public function use_editor($elementid, array $options=null, $fpoptions=null) {
        ...
        if (debugging('', DEBUG_DEVELOPER)) {
            $PAGE->requires->js('/lib/editor/butinymce/tiny_mce/'.$this->version.'/tiny_mce_src.js');
        } else {
            $PAGE->requires->js('/lib/editor/butinymce/tiny_mce/'.$this->version.'/tiny_mce.js');
        }
    ...
    protected function get_init_params($elementid, array $options=null) 
    {
        ...
        $params = array(
                    ...
                    'entity_encoding' => "raw",
                    'plugins' => "{$xmedia}advimage,safari,table,style,layer,advhr,advlink,emotions,inlinepopups,searchreplace,paste,directionality,fullscreen,moodlenolink,{$xemoticon}{$xdragmath}nonbreaking,contextmenu,insertdatetime,save,iespell,preview,print,noneditable,visualchars,xhtmlxtras,template,pagebreak,spellchecker,pdw",
                    'theme_advanced_font_sizes' => "1,2,3,4,5,6,7",
                    'theme_advanced_layout_manager' => "SimpleLayout",
                    'theme_advanced_toolbar_align' => "left",
                    'theme_advanced_toolbar_location' => "top",
                    'theme_advanced_buttons1' => "fontselect,fontsizeselect,|",
                    'theme_advanced_buttons1_add' => "bold,italic,underline,|,image,link,|,strikethrough,sub,sup,removeformat,|,bullist,numlist,|,code,|,pdw_toggle",
                    'theme_advanced_buttons2' => "formatselect,|,justifyleft,justifycenter,justifyright,|,undo,redo,|,search,replace,",
                    'theme_advanced_buttons2_add' => "|,pastetext,pasteword,|,forecolor,backcolor,|,outdent,indent,|, spellchecker,|,fullscreen",
                    'theme_advanced_buttons3' => "tablecontrols,|,hr,|,unlink,moodlenolink,|,{$xemoticon}{$xmedia}{$xdragmath},charmap,nonbreaking",
                    'theme_advanced_buttons3_add' => ",",
                    'theme_advanced_fonts' => "Trebuchet=Trebuchet MS,Verdana,Arial,Helvetica,sans-serif;Arial=arial,helvetica,sans-serif;Courier New=courier new,courier,monospace;Georgia=georgia,times new roman,times,serif;Tahoma=tahoma,arial,helvetica,sans-serif;Times New Roman=times new roman,times,serif;Verdana=verdana,arial,helvetica,sans-serif;Impact=impact;Wingdings=wingdings;Oswald=Oswald",
        ...
        if ($xemoticon) {
            ...
            $imgs = array();
            // see the butinymce plugin moodleemoticon for how the emoticon index is (ab)used :-S
            $index = 0;
